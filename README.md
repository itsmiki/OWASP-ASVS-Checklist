...
You can customize the audit scope by selecting the target ASVS levels in the settings. Checks associated with deselected levels are automatically excluded from the summary metrics and graphs. Additionally, these out-of-scope checks are visually struck through in their respective sheets for clarity.

 ![Crossed checks in the checklist.](/assets/images/crossed-checks.png)


 ## 🤝 Contributing & Feedback
Feedback is welcome! If you encounter any issues, have suggestions for improvements, or want to propose new features, please feel free to [open an issue](https://github.com/itsmiki/OWASP-ASVS-Checklist/issues) in this repository.
